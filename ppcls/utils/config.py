...
def parse_args():
    ...
    parser.add_argument(
        ...
        '--config',
        type=str,
        #default='/home/zhangss/PaddleKits/PaddleClas/ppcls/configs/Tim_Mix/MobileNetV3_small_x1_0_single_Crack.yaml',
        default='/home/zhangss/Paddles/PaddleClas/ppcls/configs/Tim_Mix/MobileNetV3_small_x1_25_close.yaml', 
